...
import org.skafcommunity.emsikeep.dao.StudentDAO;
...
import org.skafcommunity.emsikeep.prez.adapters.StudentAdapter;
...
public class ManageStudentFragment extends Fragment {
    ...
    private StudentAdapter pAdapter;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        listView = (ListView) getActivity().findViewById(R.id.list_student);
        final Context context = this.getContext();
        StudentDAO.getAll(new EntityListner<List<Student>>() {
            @Override
            public void doStuff(List<Student> list) {
                pAdapter = new StudentAdapter(context, list);
                ...
                valideBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(firstname.equals("") || lastname.equals("") || phone.equals("") || email.equals("") || password.equals("")){
                            ...
                            dialog2.dismiss();
                            dialog.dismiss();
                            getFragmentManager().beginTransaction().replace(R.id.main_content, new ManageStudentFragment()).commit();
                        }
                    }
                });
        ...
        ((TextView)getActivity().findViewById(R.id.top_bar_title_texte)).setText("GESTION DES ETUDIANTS");
        if(listView != null){
