...
import org.skafcommunity.emsikeep.prez.adapters.ProfessorAdapter;
 ...
 * Use the {@link ManageProfessorFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ManageProfessorFragment extends Fragment {
    ...
    public ManageProfessorFragment() {
    ...
    public static ManageProfessorFragment newInstance(String param1, String param2) {
        ManageProfessorFragment fragment = new ManageProfessorFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_manage_professor, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        listView = (ListView) getActivity().findViewById(R.id.list_professors);
        final Context context = this.getContext();
        ProfessorDAO.getAll(new EntityListner<List<Professor>>() {
            @Override
            public void doStuff(List<Professor> list) {
                pAdapter = new ProfessorAdapter(context, list);
                ...
                valideBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(firstname.equals("") || lastname.equals("") || phone.equals("") || email.equals("") || password.equals("")){
                            ...
                            dialog2.show();
                            Professor professorX = new Professor(lastname, firstname, email, phone);
                            ProfessorDAO.add(professorX, password);
                            Toast.makeText(getContext(), getString(R.string.added),(int)6).show();
                            dialog2.dismiss();
                            dialog.dismiss();
                            getFragmentManager().beginTransaction().replace(R.id.main_content, new ManageProfessorFragment()).commit();
                        }
                    }
                });
        ...
        ((TextView)getActivity().findViewById(R.id.top_bar_title_texte)).setText("GESTION DES PROFESSEURS");
